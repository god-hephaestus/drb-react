 ...
 return (
     <div className="absolute top-[10px] right-[10px] inline-block group">
       ...
       <ul className="hidden group-hover:block absolute top-[100%] left-0 w-[120px] bg-[#c0a162] b-[#c0a162] z-[1000] p-0 m-0">
         {languages.map((lang) => (
           <li className="list-none m-[10px]" key={lang.code}>
             <a className="flex align-center justify-between text-black no-underline text-[14px] gap-[10px] hover:bg-[#0a0a0a] hover:text-[#c0a162]"
